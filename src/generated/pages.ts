...
export type WebApiModulesPagesActiveLinkCardPointePaymentPaymentActiveLinkGetActiveLinkDetailsResponse = {
    Company?: string | null;
...
export type WebApiModulesPagesPluginsCardPointeTokenizerGetCardPointeTokenizerResponse = {
    Site?: string | null;
    UseCvv?: boolean;
};
...
export function getApiV1Cardpointepaymentactivelink(activeLinkToken: string, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: WebApiModulesPagesActiveLinkCardPointePaymentPaymentActiveLinkGetActiveLinkDetailsResponse;
    } | {
        status: 400;
    ...
    }>(`/api/v1/cardpointepaymentactivelink${QS.query(QS.explode({
        ActiveLinkToken: activeLinkToken
    }))}`, {
        ...opts
    }));
}
export function getApiV1Cardpointetokenizer(opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
        data: WebApiModulesPagesPluginsCardPointeTokenizerGetCardPointeTokenizerResponse;
    } | {
        status: 400;
        data: FwCoreApiSwashbuckleBadRequestResponse;
    } | {
